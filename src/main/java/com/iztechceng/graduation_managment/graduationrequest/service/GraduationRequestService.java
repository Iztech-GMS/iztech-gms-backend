...
public class GraduationRequestService {
    ...
    public static GraduationRequestResponse toResponse(GraduationRequest entity) {
        return GraduationRequestResponse.builder()
                ...
                .gpa(entity.getStudent().getGpa())
                .totalEarnedCredits(entity.getStudent().getTotalEarnedCredits())
                .isMandatoryCourseCompleted(entity.getStudent().isMandatoryCourseCompleted())
